        ...
        for (const uniformName in uniforms) {
            ...
            switch (uniform.type) {
                case "uniform1f":
                    ...
                    break;
                case "uniform3f":
                    const vector3 = new THREE.Vector3().fromArray(uniform.value as number[]);
                    preparedUniforms[uniformName] = { value: vector3, type: "3f" };
                    break;
                case "uniform1fv":
                ...
                case "uniform3fv":
                    ...
                    break;
                case "uniform2f":
                    const vector2 = new THREE.Vector2().fromArray(uniform.value as number[]);
                    preparedUniforms[uniformName] = { value: vector2, type: "2f" };
                    break;
                default:
